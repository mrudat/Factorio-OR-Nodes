...
assert(result[1] == 'OR-Nodes-item-roboport')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-item-accumulator-or-item-gun-turret')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-artillery-shell-or-coal-liquefaction')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-energy-weapons-damage-1-or-speed-module')
