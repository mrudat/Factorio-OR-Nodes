...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-or-{["construction-robotics"] = 3, ["logistic-robotics"] = 3}')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-or-{["electric-energy-accumulators"] = 3, turrets = 3}')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-or-{artillery = 3, ["coal-liquefaction"] = 3}')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-or-{["energy-weapons-damage-1"] = 3, ["speed-module"] = 3}')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-and-{["military-2"] = 3, turrets = 3}')
...
logt(result)
assert(type(result) == 'table')
assert(result[1] == 'OR-Nodes-and-{["electric-energy-accumulators"] = 3, turrets = 3}')
